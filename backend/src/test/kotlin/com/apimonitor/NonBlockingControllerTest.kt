...
class NonBlockingControllerTest {
    ...
    @Test
    fun `test sequential requests` () = runBlocking {
        val urls = List(NUM_REQUESTS) { "/github" }
    ...
    companion object {
        ...
        var concurrentTimes by Delegates.notNull<Long>()
        var sequentialTimes by Delegates.notNull<Long>()
        ...
        fun compareTimes() {
            ...
            println("AfterAll: Sequential requests took $sequentialTimes ms - Concurrent requests took $concurrentTimes ms, $faster was $timeDifference times faster")
        }
    }
}